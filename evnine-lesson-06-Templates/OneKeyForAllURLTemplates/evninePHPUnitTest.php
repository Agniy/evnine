 ...
 * Generated by PHPUnit on 2011-09-24 at 08:59:45.
 */
class evninePHPUnitTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Generated from @assert ('getControllerForParam_helloworld_default2_Test',$array,$param) == $array=($this->object->getControllerForParam($param=array( 'controller'=>'helloworld', 'method'=>'default2'))).
     */
    public function testGetControllerForParam_helloworld_default2_Test()
    {
        $this->assertEquals(
          $array=($this->object->getControllerForParam($param=array( 'controller'=>'helloworld', 'method'=>'default2'))),
