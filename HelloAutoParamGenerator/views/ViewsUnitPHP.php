...
class ViewsUnitPHP extends ViewsUnitPHPExtend
{
	...
	function __construct() {
		if (file_exists($_SERVER["DOCUMENT_ROOT"].'/HelloAutoParamGenerator/lib/Twig/Autoloader.php')){
			require_once($_SERVER["DOCUMENT_ROOT"].'/HelloAutoParamGenerator/lib/Twig/Autoloader.php');
