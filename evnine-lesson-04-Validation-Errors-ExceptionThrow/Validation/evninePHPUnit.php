...
/**
 * @assert ('getControllerForParam_validation_default_Test',$array,$param) == $array=($this->object->getControllerForParam($param=array( 'controller'=>'validation', 'method'=>'default', 'REQUEST'=>array( 'path_id'=>'777'), 'ajax'=>'ajax')))
 * @access public
 * @param param
 * @return array
 */
