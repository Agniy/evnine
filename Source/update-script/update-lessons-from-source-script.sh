...
[ ! -f "$1/${sub_path}evnine.controller.php" ] && [ -f "$1/${sub_path}$file_to_copy" ] && cp "Source/${lang_dir}${file_to_copy}" "$1/${sub_path}$file_to_copy" >&2 && echo "update $1/${sub_path}$file_to_copy" >&2
